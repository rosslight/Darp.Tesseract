...
public class StringDoubleMap : global::System.IDisposable 
    , global::System.Collections.Generic.IDictionary<string, double>
 {
  private global::System.Runtime.InteropServices.HandleRef swigCPtr;
  protected bool swigCMemOwn;

  internal StringDoubleMap(global::System.IntPtr cPtr, bool cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = new global::System.Runtime.InteropServices.HandleRef(this, cPtr);
  }

  internal static global::System.Runtime.InteropServices.HandleRef getCPtr(StringDoubleMap obj) {
    return (obj == null) ? new global::System.Runtime.InteropServices.HandleRef(null, global::System.IntPtr.Zero) : obj.swigCPtr;
  }

  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(StringDoubleMap obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          TesseractNativePINVOKE.delete_StringDoubleMap(swigCPtr);
        }
  ...
  global::System.Collections.Generic.IEnumerator<global::System.Collections.Generic.KeyValuePair<string, double>> global::System.Collections.Generic.IEnumerable<global::System.Collections.Generic.KeyValuePair<string, double>>.GetEnumerator() {
    return new StringDoubleMapEnumerator(this);
  }
  ...
  public StringDoubleMapEnumerator GetEnumerator() {
    return new StringDoubleMapEnumerator(this);
  }
  ...
  public StringDoubleMap() : this(TesseractNativePINVOKE.new_StringDoubleMap__SWIG_0(), true) {
    if (TesseractNativePINVOKE.SWIGPendingException.Pending) throw TesseractNativePINVOKE.SWIGPendingException.Retrieve();
  }

  public StringDoubleMap(StringDoubleMap other) : this(TesseractNativePINVOKE.new_StringDoubleMap__SWIG_1(StringDoubleMap.getCPtr(other)), true) {
    if (TesseractNativePINVOKE.SWIGPendingException.Pending) throw TesseractNativePINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = TesseractNativePINVOKE.StringDoubleMap_size(swigCPtr);
    if (TesseractNativePINVOKE.SWIGPendingException.Pending) throw TesseractNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private bool empty() {
    bool ret = TesseractNativePINVOKE.StringDoubleMap_empty(swigCPtr);
    if (TesseractNativePINVOKE.SWIGPendingException.Pending) throw TesseractNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void Clear() {
    TesseractNativePINVOKE.StringDoubleMap_Clear(swigCPtr);
    if (TesseractNativePINVOKE.SWIGPendingException.Pending) throw TesseractNativePINVOKE.SWIGPendingException.Retrieve();
  }

  private double getitem(string key) {
    double ret = TesseractNativePINVOKE.StringDoubleMap_getitem(swigCPtr, key);
    if (TesseractNativePINVOKE.SWIGPendingException.Pending) throw TesseractNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(string key, double x) {
    TesseractNativePINVOKE.StringDoubleMap_setitem(swigCPtr, key, x);
    if (TesseractNativePINVOKE.SWIGPendingException.Pending) throw TesseractNativePINVOKE.SWIGPendingException.Retrieve();
  }

  public bool ContainsKey(string key) {
    bool ret = TesseractNativePINVOKE.StringDoubleMap_ContainsKey(swigCPtr, key);
    if (TesseractNativePINVOKE.SWIGPendingException.Pending) throw TesseractNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void Add(string key, double value) {
    TesseractNativePINVOKE.StringDoubleMap_Add(swigCPtr, key, value);
    if (TesseractNativePINVOKE.SWIGPendingException.Pending) throw TesseractNativePINVOKE.SWIGPendingException.Retrieve();
  }

  public bool Remove(string key) {
    bool ret = TesseractNativePINVOKE.StringDoubleMap_Remove(swigCPtr, key);
    if (TesseractNativePINVOKE.SWIGPendingException.Pending) throw TesseractNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private global::System.IntPtr create_iterator_begin() {
    global::System.IntPtr ret = TesseractNativePINVOKE.StringDoubleMap_create_iterator_begin(swigCPtr);
    if (TesseractNativePINVOKE.SWIGPendingException.Pending) throw TesseractNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private string get_next_key(global::System.IntPtr swigiterator) {
    string ret = TesseractNativePINVOKE.StringDoubleMap_get_next_key(swigCPtr, swigiterator);
    if (TesseractNativePINVOKE.SWIGPendingException.Pending) throw TesseractNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void destroy_iterator(global::System.IntPtr swigiterator) {
    TesseractNativePINVOKE.StringDoubleMap_destroy_iterator(swigCPtr, swigiterator);
    if (TesseractNativePINVOKE.SWIGPendingException.Pending) throw TesseractNativePINVOKE.SWIGPendingException.Retrieve();
  }
