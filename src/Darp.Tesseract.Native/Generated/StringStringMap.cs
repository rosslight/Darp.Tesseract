...
public class StringStringMap : global::System.IDisposable 
    , global::System.Collections.Generic.IDictionary<string, string>
 {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(StringStringMap obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          TesseractNativePINVOKE.delete_StringStringMap(swigCPtr);
        }
  ...
  public StringStringMap() : this(TesseractNativePINVOKE.new_StringStringMap__SWIG_0(), true) {
    if (TesseractNativePINVOKE.SWIGPendingException.Pending) throw TesseractNativePINVOKE.SWIGPendingException.Retrieve();
  }

  public StringStringMap(StringStringMap other) : this(TesseractNativePINVOKE.new_StringStringMap__SWIG_1(StringStringMap.getCPtr(other)), true) {
    if (TesseractNativePINVOKE.SWIGPendingException.Pending) throw TesseractNativePINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = TesseractNativePINVOKE.StringStringMap_size(swigCPtr);
    if (TesseractNativePINVOKE.SWIGPendingException.Pending) throw TesseractNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private bool empty() {
    bool ret = TesseractNativePINVOKE.StringStringMap_empty(swigCPtr);
    if (TesseractNativePINVOKE.SWIGPendingException.Pending) throw TesseractNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void Clear() {
    TesseractNativePINVOKE.StringStringMap_Clear(swigCPtr);
    if (TesseractNativePINVOKE.SWIGPendingException.Pending) throw TesseractNativePINVOKE.SWIGPendingException.Retrieve();
  }

  private string getitem(string key) {
    string ret = TesseractNativePINVOKE.StringStringMap_getitem(swigCPtr, key);
    if (TesseractNativePINVOKE.SWIGPendingException.Pending) throw TesseractNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(string key, string x) {
    TesseractNativePINVOKE.StringStringMap_setitem(swigCPtr, key, x);
    if (TesseractNativePINVOKE.SWIGPendingException.Pending) throw TesseractNativePINVOKE.SWIGPendingException.Retrieve();
  }

  public bool ContainsKey(string key) {
    bool ret = TesseractNativePINVOKE.StringStringMap_ContainsKey(swigCPtr, key);
    if (TesseractNativePINVOKE.SWIGPendingException.Pending) throw TesseractNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void Add(string key, string value) {
    TesseractNativePINVOKE.StringStringMap_Add(swigCPtr, key, value);
    if (TesseractNativePINVOKE.SWIGPendingException.Pending) throw TesseractNativePINVOKE.SWIGPendingException.Retrieve();
  }

  public bool Remove(string key) {
    bool ret = TesseractNativePINVOKE.StringStringMap_Remove(swigCPtr, key);
    if (TesseractNativePINVOKE.SWIGPendingException.Pending) throw TesseractNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private global::System.IntPtr create_iterator_begin() {
    global::System.IntPtr ret = TesseractNativePINVOKE.StringStringMap_create_iterator_begin(swigCPtr);
    if (TesseractNativePINVOKE.SWIGPendingException.Pending) throw TesseractNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private string get_next_key(global::System.IntPtr swigiterator) {
    string ret = TesseractNativePINVOKE.StringStringMap_get_next_key(swigCPtr, swigiterator);
    if (TesseractNativePINVOKE.SWIGPendingException.Pending) throw TesseractNativePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void destroy_iterator(global::System.IntPtr swigiterator) {
    TesseractNativePINVOKE.StringStringMap_destroy_iterator(swigCPtr, swigiterator);
    if (TesseractNativePINVOKE.SWIGPendingException.Pending) throw TesseractNativePINVOKE.SWIGPendingException.Retrieve();
  }
