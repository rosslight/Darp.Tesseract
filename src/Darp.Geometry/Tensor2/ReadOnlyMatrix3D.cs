...
public readonly struct ReadOnlyMatrix3D : IReadOnlyMatrixD
{
    ...
    public static ReadOnlyMatrix3D FromMatrix(ReadOnlyMatrixXD readOnlyMatrix) => new(readOnlyMatrix);
    ...
    public static Matrix3D operator *(ReadOnlyMatrix3D a, ReadOnlyMatrix3D b) => new(a._readOnlyMatrix * b._readOnlyMatrix);
    public static Vector3D operator *(ReadOnlyMatrix3D a, ReadOnlyVector3D b) => new(new VectorXD(a.AsMatrix() * b.AsMatrix()));
