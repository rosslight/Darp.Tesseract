...
{
    public static Vector3D TransformPoint(this IReadOnlyIsometry3D transform, IReadOnlyVector3D point) => Transform(transform, point, true);
    public static Vector3D TransformDirection(this IReadOnlyIsometry3D transform, IReadOnlyVector3D direction) => Transform(transform, direction, false);
